...
class TradingEnv(gym.Env):
    ...
    def __init__(self, df):
        ...
        # TODO use history_lookback_steps instead of hard-coded '5'
    ...
    def reset(self):
        ...
        self.current_step = random.randint(
            0, len(self.df.loc[:, 'close'].values) - 6)
        # TODO use history_lookback_steps instead of hard-coded '5'
    ...
    def _next_observation(self):
        ...
        frame = np.array([
            ...
            # TODO use history_lookback_steps instead of hard-coded '5'
            # TODO add best bid and best ask columns
        ])
    ...
    def step(self, action):
        ...
        # TODO consider using this modifier
    ...
    def _take_action(self, action):
        ...
        if action_type == BUY:
            ...
            # only sell with sufficient shares
            if self.shares_held < shares_sold:
